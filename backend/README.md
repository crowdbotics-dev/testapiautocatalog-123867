...
## Project Structure
    ...
    ├── testapiautocatalog_123867  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_123867`
...
2. Clone this repo and `cd testapiautocatalog_123867`
